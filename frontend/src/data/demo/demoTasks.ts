...
export const DEMO_TASKS: Task[] = [
  ...
  // ===== 品物操作通知（Phase 55） =====
  {
    ...
    residentId: 'resident-001',
    title: '【新規】いちご',
    description: '家族が新しい品物を登録しました。',
    taskType: 'item_created' as TaskType,
    relatedItemId: 'demo-item-new',
    dueDate: getDateString(1), // 24時間後に自動削除
    status: 'pending' as TaskStatus,
    priority: 'medium' as TaskPriority,
    notificationSent: false,
    isAutoGenerated: true,
    createdBy: 'system',
    createdAt: getDateTimeString(0, 10),
    updatedAt: getDateTimeString(0, 10),
  },
  {
    id: 'task-011',
    residentId: 'resident-001',
    title: '【変更】バナナ',
    description: '家族が品物情報を更新しました。提供方法: 皮を剥いて一口大にカット → 輪切りに変更',
    taskType: 'item_updated' as TaskType,
    relatedItemId: 'demo-item-001',
    dueDate: getDateString(1), // 24時間後に自動削除
    status: 'pending' as TaskStatus,
    priority: 'medium' as TaskPriority,
    ...
    isAutoGenerated: true,
    createdBy: 'system',
    createdAt: getDateTimeString(0, 9),
    updatedAt: getDateTimeString(0, 9),
  },
  {
    id: 'task-012',
    residentId: 'resident-001',
    title: '【削除】ぶどう',
    description: '家族が品物を削除しました。',
    taskType: 'item_deleted' as TaskType,
    dueDate: getDateString(1), // 24時間後に自動削除
    status: 'pending' as TaskStatus,
    priority: 'medium' as TaskPriority,
    notificationSent: false,
