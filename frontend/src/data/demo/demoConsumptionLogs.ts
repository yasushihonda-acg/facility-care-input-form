...
import type { ConsumptionLog, ConsumptionStatus } from '../../types/consumptionLog';
...
export const DEMO_CONSUMPTION_LOGS: ConsumptionLog[] = [
  // ===== バナナ (demo-item-001) のログ =====
  {
    ...
    consumptionRate: 80,
    consumptionStatus: 'mostly_eaten' as ConsumptionStatus,
    quantityBefore: 4,
    quantityAfter: 3.5,
  ...
  // ===== キウイ (demo-item-002) のログ =====
  {
    ...
    consumptionRate: 95,
    consumptionStatus: 'all_eaten' as ConsumptionStatus,
    quantityBefore: 3,
    quantityAfter: 2,
  ...
  // ===== りんご (demo-item-003) のログ =====
  {
    ...
    consumptionRate: 20,
    consumptionStatus: 'little_eaten' as ConsumptionStatus,
    quantityBefore: 2,
    quantityAfter: 1.75,
  ...
  // ===== 黒豆 (demo-item-011) のログ =====
  {
    ...
    consumedQuantity: 10,
    consumptionRate: 50,
    consumptionStatus: 'half_eaten' as ConsumptionStatus,
    quantityBefore: 200,
    quantityAfter: 180,
    recordedBy: '田中花子',
    recordedAt: getDateTimeString(-5, 12, 30),
