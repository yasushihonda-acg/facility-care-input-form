...
| ID | 名前 | 詳細指示 | キーワード |
|----|------|---------|-----------|
| `preset-ban-shichifuku` | 🈲 七福のお菓子は出さない | ★七福さんのお菓子は出さないでください。 | 七福, お菓子, おやつ |
| `preset-ban-sugar-cheese` | ⚠️ 黒砂糖・チーズは指定日以外禁止 | こちらからお願いした日以外は、引き続き黒砂糖・チーズは出さないでください。 | 黒砂糖, チーズ |
...
| 元のプリセット | 判定 | 理由 |
|---------------|------|------|
| 🍅 トマト月水金禁止 | ❌ 削除 | 参考資料に記載なし。黒砂糖・チーズ・七福のお菓子と混同の可能性 |
...
│       ├── ItemForm.tsx             # AI提案保存ダイアログ追加
│       └── RequestBuilder.tsx       # プリセット選択連携
├── components/
│   └── family/
