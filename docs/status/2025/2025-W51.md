...
| E2Eテスト | 265件（16件スキップ含む、Phase 22.3で21件追加） |
| 主要完了Phase | Phase 13〜22 |
...
| `frontend/src/pages/family/ItemDetail.tsx` | 編集ボタン追加 |
| `frontend/src/App.tsx` | `/family/items/:id/edit` ルート追加 |
| `docs/ITEM_MANAGEMENT_SPEC.md` | Phase 22仕様追加（セクション9） |
| `frontend/e2e/item-edit.spec.ts` | E2Eテスト21件追加（locator構文修正含む） |

**コミット**: `e5fb97a` (Phase 22), `6efa8fd` (Phase 22.3)

**E2E検証**: 265件（16件スキップ含む）全パス
