...
| STAFF-087 | 水分タブで記録送信→hydration API呼び出し | 正しいAPI呼び出し |
| STAFF-088 | 食事タブで記録送信→submitMealRecord呼び出し | 正しいAPI呼び出し |

#### チャット送信関連

| ID | テストケース | 期待結果 |
|----|-------------|----------|
| STAFF-089 | 水分記録時に#水分摂取💧タグが付く | タグ含む |
| STAFF-090 | 食事記録時に#食事🍚タグが付く | タグ含む |
| STAFF-091 | 重要選択時に#重要⚠️タグが付く（両タブ） | タグ含む |
| STAFF-092 | デイサービス利用中で#デイ利用中[X]タグ付く | タグ含む |
