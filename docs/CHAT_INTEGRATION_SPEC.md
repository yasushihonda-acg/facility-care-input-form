...
| # | 機能 | 説明 | 優先度 | Phase |
|---|------|------|--------|-------|
| F1 | **チャット一覧** | アクティブなスレッドのみ表示 | 高 | 18 |
| F2 | **品物チャットスペース** | 品物ごとにメッセージスレッド | 高 | 18 |
| F3 | **双方向メッセージ** | スタッフ⇔家族の送受信 | 高 | 18 |
| F4 | **チャット開始ボタン** | 品物一覧からチャットを開始 | 高 | 18 |
| F5 | **通知バッジ（フッター）** | 未読メッセージ数を表示 | 中 | 18 |
| F6 | **ホーム通知** | 新着メッセージをホームに表示 | 中 | 18 |
| F7 | **記録の自動反映** | 提供記録がスレッドに自動表示 | 低 | **19（後回し）** |
