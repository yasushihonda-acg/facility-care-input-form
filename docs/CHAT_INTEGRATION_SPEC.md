...
>
> **実装完了日**: 2025年12月19日（Phase 18.1〜18.5 全完了）
...
| F6 | **ホーム通知** | 新着メッセージをホームに表示 | 中 | 18 | 🔜 Phase 19 |
| F7 | **記録の自動反映** | 提供記録がスレッドに自動表示 | 低 | **19（後回し）** | 🔜 Phase 19 |

**段階的実装の方針**:
- Phase 18: チャット機能の基本（一覧・送受信・通知バッジ）を優先 ✅ 完了
- Phase 19: ホーム通知・記録の自動反映は後回し（複雑な連携ロジックを慎重に設計）
...
### 12.6 残タスク（Phase 19予定）

| # | 機能 | 説明 |
|---|------|------|
| F6 | ホーム通知 | 新着メッセージをホームに表示 |
| F7 | 記録の自動反映 | 提供記録がスレッドに自動表示 |
