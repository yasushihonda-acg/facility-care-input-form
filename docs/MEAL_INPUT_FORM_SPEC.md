...
| 5 | 食事はいつのことですか？ | ラジオボタン | ○ | 朝 / 昼 / 夜 | 食事はいつのことですか？ |
| 6 | 主食の摂取量は何割ですか？ | ドロップダウン | - | 0〜10割 | 主食の摂取量は何割ですか？ |
| 7 | 副食の摂取量は何割ですか？ | ドロップダウン | - | 0〜10割 | 副食の摂取量は何割ですか？ |
| 8 | 注入の種類は？ | ドロップダウン | - | 経管栄養の種類リスト | 注入の種類 |
| 9 | 注入量は？ | ドロップダウン | - | cc単位の選択肢 | 注入量は何ccですか？ |
| 10 | 間食は何を食べましたか？ | テキスト入力 | - | 自由記述 | 間食は何を食べましたか？ |
| 11 | 特記事項 | テキストエリア | - | 自由記述（複数行） | 特記事項 |
| 12 | 重要特記事項集計表に反映させますか？ | ラジオボタン | ○ | 重要 / 重要ではない | 重要特記事項集計表に反映させますか？ |
| 13 | 写真アップロード | ファイル選択 | - | 画像ファイル | (Google Drive) |
...
3. **注入の種類リスト**: 選択肢の定義が必要
4. **注入量の選択肢**: 刻み幅の定義が必要
5. **写真アップロード**: Google Drive連携の実装方針
