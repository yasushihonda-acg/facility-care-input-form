...
- **Phase 15.7設計完了**: 残り対応による在庫・統計の分離計算
...
| ステップ | 内容 | 状態 |
|----------|------|------|
| 15.7.1 | 計算関数追加 (`consumptionCalc.ts`) | 未着手 |
| 15.7.2 | StaffRecordDialog UI更新 | 未着手 |
| 15.7.3 | ConsumptionLog型拡張 | 未着手 |
| 15.7.4 | recordConsumptionLog API更新 | 未着手 |
| 15.7.5 | 在庫更新ロジック修正 | 未着手 |
| 15.7.6 | E2Eテスト追加 | 未着手 |
