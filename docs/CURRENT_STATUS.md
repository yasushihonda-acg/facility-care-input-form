...
> **最終更新**: 2025年12月19日 (Phase 18 チャット連携機能 - 設計完了)
>
...
| Phase | 内容 | 工数 | 状態 |
|-------|------|------|------|
| 18.1 | データモデル・API基盤 | 4-6h | 未着手 |
| 18.2 | チャットUI基盤（ChatListPage含む） | 8-10h | 未着手 |
| 18.3 | 通知システム（フッター改修含む） | 4-5h | 未着手 |
| 18.4 | 家族側チャット連携 | 4-5h | 未着手 |
| 18.5 | デモモード対応・テスト | 3-4h | 未着手 |
| **合計** | | **23-30h** | |

**主要機能**:
- **チャット一覧（ChatListPage）** - アクティブなスレッドのみ表示
- 品物チャットスペース（スタッフ⇔家族の双方向メッセージ）
- **品物一覧にチャット開始ボタン** - 品物管理画面からチャットを開始
- 通知バッジ（フッター）・ホーム通知
- デモモード対応

**次のステップ**: Phase 18.1 データモデル・API基盤から実装開始
