...
| **E2Eテスト** | 216件パス（2025-12-20時点、Phase 15.7追加4件含む） |
...
| ステップ | 内容 | 状態 |
|----------|------|------|
| 15.7.1 | 計算関数追加 (`consumptionCalc.ts`) | ✅完了 |
| 15.7.2 | StaffRecordDialog UI更新 | ✅完了 |
| 15.7.3 | ConsumptionLog型拡張 | ✅完了 |
| 15.7.4 | recordConsumptionLog API更新 | ✅完了 |
| 15.7.5 | 在庫更新ロジック修正 | ✅完了 |
| 15.7.6 | E2Eテスト追加 | ✅完了 |
