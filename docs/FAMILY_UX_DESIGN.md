...
| 🍑 熟した柿（柔らかい部分も捨てずに） | 熟している柿です。柔らかくなっている部分がとてもおいしいので、傷んでいると判断せず、捨てずにそのままカットして提供。 |
...
| プリセット名 | 詳細内容 |
|-------------|----------|
| 🈲 七福のお菓子は出さない | ★七福さんのお菓子は出さないでください。（頻出・重要） |
| ⚠️ 黒砂糖・チーズは指定日以外禁止 | こちらからお願いした日以外は、引き続き黒砂糖・チーズは出さないで。 |
